...
export default {
    ...
    data() {
        return {
            ...
            name: "Sapporo",
            moment: moment,
            imageSrc: "/image/AdobeStock_308471636_Preview.jpeg",
            cityDescription: `Embrace winter wonderland vibes in Sapporo, the largest city of the northern island of Hokkaido. Experience the magic of the annual Sapporo Snow Festival, hit the slopes at skiing resorts, and indulge in its vibrant food scene.`,
        };
    },
    created() {
