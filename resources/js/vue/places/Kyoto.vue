...
export default {
    ...
    data() {
        return {
            ...
            name: "Kyoto",
            moment: moment,
            imageSrc: "/image/AdobeStock_204364962_Preview.jpeg",
            cityDescription: `Step back in time in Kyoto, once the capital of Japan. Immerse yourself in its rich history as you explore classical Buddhist temples, imperial palaces, and traditional wooden houses.`,
        };
    },
    created() {
