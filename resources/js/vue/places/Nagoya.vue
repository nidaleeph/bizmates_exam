...
export default {
    ...
    data() {
        return {
            ...
            name: "Nagoya",
            moment: moment,
            imageSrc: "/image/AdobeStock_252871660_Preview.jpeg",
            cityDescription: `Uncover the industrial charm of Nagoya, capital of Japan’s Aichi Prefecture. Immerse yourself in its bustling manufacturing and shipping hub located in central Honshu.`,
        };
    },
    created() {
