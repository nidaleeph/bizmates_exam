...
export default {
    ...
    data() {
        return {
            ...
            name: "Osaka",
            moment: moment,
            imageSrc: "/image/AdobeStock_262803806_Preview.jpeg",
            cityDescription: `Experience the dynamic energy of Osaka, a large port city on the island of Honshu. Dive into its modern architecture, vibrant nightlife, and savor its hearty street food scene.`,
        };
    },
    created() {
