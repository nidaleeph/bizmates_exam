...
export default {
    ...
    data() {
        return {
            ...
            name: "Tokyo",
            moment: moment,
            imageSrc: "/image/AdobeStock_265237090_Preview.jpeg",
            cityDescription: `Experience the vibrant clash of the ultramodern and the traditional in Tokyo, Japan’s bustling capital. Marvel at neon-lit skyscrapers towering over historic temples and bustling streets.`,
        };
    },
    created() {
